...
void setup()
{
    ...
    USBSerial.println("");
    USBSerial.println("");
    USBSerial.println("TFT_eSPI library test!");
    ...
    yield();
    USBSerial.println(testLines(TFT_CYAN));
    ...
    yield();
    USBSerial.println(testFastLines(TFT_RED, TFT_BLUE));
    // total+=testFastLines(TFT_RED, TFT_BLUE);
    // delay(500);

    yield();
    USBSerial.print(F("Rectangles (outline)     "));
    yield();
    USBSerial.println(testRects(TFT_GREEN));
    // total+=testRects(TFT_GREEN);
    // delay(500);

    yield();
    USBSerial.print(F("Rectangles (filled)      "));
    yield();
    USBSerial.println(testFilledRects(TFT_YELLOW, TFT_MAGENTA));
    // total+=testFilledRects(TFT_YELLOW, TFT_MAGENTA);
    // delay(500);

    yield();
    USBSerial.print(F("Circles (filled)         "));
    yield();
    USBSerial.println(testFilledCircles(10, TFT_MAGENTA));
    // total+= testFilledCircles(10, TFT_MAGENTA);

    yield();
    USBSerial.print(F("Circles (outline)        "));
    yield();
    USBSerial.println(testCircles(10, TFT_WHITE));
    // total+=testCircles(10, TFT_WHITE);
    // delay(500);

    yield();
    USBSerial.print(F("Triangles (outline)      "));
    yield();
    ...
    yield();
    USBSerial.print(F("Triangles (filled)       "));
    yield();
    ...
    yield();
    USBSerial.print(F("Rounded rects (outline)  "));
    yield();
    ...
    yield();
    USBSerial.print(F("Rounded rects (filled)   "));
    yield();
    ...
    yield();
    // USBSerial.print(F("Total = ")); USBSerial.println(total);

    // yield();USBSerial.println(millis()-tn);
}
